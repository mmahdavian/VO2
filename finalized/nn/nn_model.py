...
class NN_Model(nn.Module):
    ...
    def forward(self, time, speed, HR, general):
        ...
        ## time
        x_time = self.drop(self.pool1(self.relu1(self.bn1(self.conv1(time)+time))))
        x_time = self.pool2(self.relu2(self.bn2(self.conv2(x_time)+self.proj2(x_time))))

        x_time_long = self.drop(self.pool1(self.relu1(self.bn1(self.long_conv1(time)+time))))
...
#        x_time = self.relu4(self.bn4(self.conv4(x_time)+self.proj4(x_time)))
        ...
        ## speed
        x_speed = self.drop(self.pool1(self.relu1(self.bn1(self.conv1(speed)+speed))))
        x_speed = self.pool2(self.relu2(self.bn2(self.conv2(x_speed)+self.proj2(x_speed))))

        x_speed_long = self.drop(self.pool1(self.relu1(self.bn1(self.long_conv1(speed)+speed))))
...
#        x_speed = self.relu4(self.bn4(self.conv4(x_speed)+self.proj4(x_speed)))
        ...
        ## HR
        x_HR = self.drop(self.pool1(self.relu1(self.bn1(self.conv1(HR)+HR))))
        x_HR = self.pool2(self.relu2(self.bn2(self.conv2(x_HR)+self.proj2(x_HR))))

        x_HR_long = self.drop(self.pool1(self.relu1(self.bn1(self.long_conv1(HR)+HR))))
